...
[![NPM Version](https://img.shields.io/npm/v/@hishprorg/quidem-et.svg?&style=flat-square)](https://www.npmjs.org/package/@hishprorg/quidem-et)
[![Build Status](https://api.travis-ci.org/Alex-Werner/@hishprorg/quidem-et.svg?branch=master)](https://travis-ci.com/Alex-Werner/@hishprorg/quidem-et)
...
```js
const {FSLock, File, Directory} = require('@hishprorg/quidem-et');
